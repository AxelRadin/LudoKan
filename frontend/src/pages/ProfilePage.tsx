    ...
    >
      ...
      >
        <Box>
          ...
          >
            {t('profilePage.favoritesTitle', { count: gamesFavoris.length })}
          </Typography>
        </Box>
        <Box
          sx={{
        ...
        >
          ...
          >
            {gamesFavoris.length <= 1
              ? t('profilePage.favoritesCount', { count: gamesFavoris.length })
              : t('profilePage.favoritesCountPlural', {
                  count: gamesFavoris.length,
                })}
          </Typography>
        </Box>
      </Box>
