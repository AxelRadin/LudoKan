...
urlpatterns = [
    ...
    path("microsoft/connect-url/", XboxConnectInitiateView.as_view(), name="xbox_connect_url"),
    path("microsoft/callback/", XboxConnectCallbackView.as_view(), name="xbox_callback"),
