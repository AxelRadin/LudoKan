...
def sample_user_data():
    ...
    return {"email": "testuser@example.com", "password": "SuperPass123!", "pseudo": "testuser"}


@pytest.fixture
def user(db):
    """Créer un utilisateur existant"""
    return User.objects.create_user(email="existing@example.com", password="SuperPass123!", pseudo="existinguser")
